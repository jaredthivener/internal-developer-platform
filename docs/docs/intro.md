...
See [using the IDP](./using-the-idp.md), [architecture](./architecture.md), [local development](./local-development.md), and [roadmap](./roadmap.md) for the next level of detail.
